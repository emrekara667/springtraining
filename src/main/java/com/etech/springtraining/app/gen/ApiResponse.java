package com.etech.springtraining.app.gen;
...
@JsonPropertyOrder({"httpHeader", "httpsStatusCode", "message", "data", "otherParams"})
public class ApiResponse <T>{
   ...
   /* private final HttpHeaders httpHeaders;
    ...
    private ApiResponse(ApiResponse builder){
    ...
    public static class ApiResponseBuilder<T>{
        ...
        public ApiResponseBuilder(int httpStatusCode, String message){
            this.httpHeaders = httpStatusCode;
